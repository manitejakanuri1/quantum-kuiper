                ...
                <div className="max-w-6xl mx-auto">
                    <div className="flex items-center justify-between mb-8">
                        <div>
                            ...
                            <p className="text-gray-400 mt-1">Manage your AI personas and their configurations</p>
                        </div>
                    ...
                    <div className="bg-[#111111] rounded-2xl border border-white/5 p-12 text-center">
                        ...
                        <h3 className="text-lg font-medium text-white mb-2">No personas yet</h3>
                        <p className="text-gray-400 text-sm mb-6">Create your first persona to get started</p>
